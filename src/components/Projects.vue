          ...
          <v-flex class='card-border' d-flex xs12 md6 mt-3 v-for="card in cards" v-bind="{ [`xs${card.flex}`]: true }"
            ...
            <v-card>
              ...
              <v-card-actions>
                ...
                <v-spacer></v-spacer>
                <v-btn class='btnStrng' color="blue-grey" dark v-on:click.native="display(card)">View
                  <v-icon dark right>laptop_chromebook</v-icon>
                </v-btn>
                <v-spacer></v-spacer>
  ...
  <!--<div>
        ...
        <div id="app">
            ...
            <v-app id="inspire">
                <v-layout column>
                    -->
  <!--<v-flex d-flexx xs12 sm6 md4>
                        <br>
                        <v-card>
                            <v-container fluid grid-list-md>
                                <v-layout row wrap>
                                    <v-flex d-flex v-for="card in cards" v-bind="{ [`xs${card.flex}`]: true }" :key="card.title">
                                        <v-card>
                                            <v-card-media :src="card.src" height="200px">
                                                <v-container fill-height fluid>
                                                    <v-layout fill-height>
                                                        <v-flex xs12 align-end flexbox>
                                                            <!--<span class="headline strngBtn" v-text="card.title"></span>-->
  <!--</v-flex>
                                                    </v-layout>
                                                </v-container>
                                            </v-card-media>
...
<script>
  export default {
    ...
    data() {
      return {
        show: false,
        lorem: `Lorem ipsum dolor sit amet, mel at clita quando. Te sit oratio vituperatoribus, nam 
        ...
        cards: [{
            ...
            src: "https://cdn.buttercms.com/OUEb12H8TT6nV2fOPPSE",
            flex: 6
          ...
          },
          {
            ...
            src: "https://cdn.buttercms.com/gRQpSAHmToKvahSVWxsA",
            flex: 6
          ...
          },
          {
            ...
            src: "https://cdn.buttercms.com/cJPqFLNdSyaK30Bw7kbN",
            flex: 6
          ...
          },
          {
            ...
            src: "https://res.cloudinary.com/dmglopmul/image/upload/v1531890965/mariposaImageP.jpg",
            flex: 6
          ...
          },
          {
            ...
            src: "https://res.cloudinary.com/dmglopmul/image/upload/v1530327261/aspa.jpg",
            flex: 6
          },
          {
            title: 'Recipe Box',
            ...
            src: "https://res.cloudinary.com/dmglopmul/image/upload/v1529491072/recipeBox.jpg",
            flex: 6
          },
          {
            title: 'Markdown Peek',
            ...
            src: 'https://res.cloudinary.com/dmglopmul/image/upload/v1529501983/markdown.png',
            flex: 6
          },
          {
            title: 'Calculator',
            ...
            src: 'https://res.cloudinary.com/dmglopmul/image/upload/v1529504760/calculator.jpg',
            flex: 6
          },
          {
            title: 'Simon Game',
            ...
            src: 'https://res.cloudinary.com/dmglopmul/image/upload/v1529505532/simon.jpg',
            flex: 6
          ...
          },
          {
            ...
            src: 'https://res.cloudinary.com/dmglopmul/image/upload/v1529506690/wikipedia.jpg',
            flex: 6
          },
          {
            title: 'Twitch',
            ...
            src: 'https://res.cloudinary.com/dmglopmul/image/upload/v1529506574/twitch.png',
            flex: 6
          },
          {
            title: 'Local Weather',
            ...
            src: 'https://res.cloudinary.com/dmglopmul/image/upload/v1529508180/weather.jpg',
            flex: 6
          },
          {
            ...
            src: 'https://res.cloudinary.com/dmglopmul/image/upload/v1529508744/pomodoro.png',
            flex: 6
          ...
          },
          {
            ...
            src: 'https://res.cloudinary.com/dmglopmul/image/upload/v1529508887/tictactoe.jpg',
            flex: 6
          },
          {
            title: 'Random Quotes',
            ...
            src: 'https://res.cloudinary.com/dmglopmul/image/upload/v1529509063/quote.jpg',
            flex: 6
          },
          {
            title: 'todo list',
            link: 'https://todolistforprocrastinators.herokuapp.com/todo',
            ...
            src: 'https://res.cloudinary.com/dmglopmul/image/upload/v1529509174/todoList.jpg',
            flex: 6
          }
        ]
      }
